...
<!--                    <td>${item.getCategory_id()}</td>
                    ...
                    <td>
                        <a href="diarylist?id=${item.getId()}&uid=${item.getUser_id()}&mod=2" onclick="return showDeleteConfirmation();">Delete</a>
                        <a href="diarylist?id=${item.getId()}&mod=3">Update</a>
                        <a href="diarylist?id=${item.getId()}&mod=4">View</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
        ...
        <script type="text/javascript">
                            ...
                            if (${empty data}) {
                                alert("Bạn chưa có bài nhật ký nào.");
                            }
        </script>
